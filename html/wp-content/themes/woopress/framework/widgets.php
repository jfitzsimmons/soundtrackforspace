...
class Etheme_Brands_Widget extends WP_Widget {
    ...
    function Etheme_Brands_Widget() {
        ...
        $this->WP_Widget('etheme-brands', '8theme - '.__('Brands Filter', ETHEME_DOMAIN), $widget_ops);
...
class Etheme_Search_Widget extends WP_Widget {
    ...
    function Etheme_Search_Widget() {
        ...
        $this->WP_Widget('etheme-search', '8theme - '.__('Search From', ETHEME_DOMAIN), $widget_ops);
...
class Etheme_QRCode_Widget extends WP_Widget {
    ...
    function Etheme_QRCode_Widget() {
        ...
        $this->WP_Widget('etheme-qr-code', '8theme - '.__('QR Code', ETHEME_DOMAIN), $widget_ops);
...
class Etheme_StatickBlock_Widget extends WP_Widget {
    ...
    function Etheme_StatickBlock_Widget() {
        ...
        $this->WP_Widget('etheme-static-block', '8theme - '.__('Statick Block', ETHEME_DOMAIN), $widget_ops);
